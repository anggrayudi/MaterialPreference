...
import static com.anggrayudi.materialpreference.sample.billing.Constants.BASE_64_ENCODED_PUBLIC_KEY;
...
public class BillingManager implements PurchasesUpdatedListener {
    ...
    public int mBillingClientResponseCode = BILLING_MANAGER_NOT_INITIALIZED;
    ...
    public void startServiceConnection(final Runnable executeOnSuccess) {
        mBillingClient.startConnection(new BillingClientStateListener() {
            ...
            public void onBillingServiceDisconnected() {
                mBillingClientResponseCode = BillingResponse.SERVICE_DISCONNECTED;
