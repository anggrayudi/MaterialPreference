...
public class SeekBarDialogPreference extends DialogPreference {
    ...
    SeekBarPreference.ValueFormatter mFormatter;
    ...
    public SeekBarDialogPreference(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, R.style.Preference_DialogPreference_SeekBarDialogPreference);
    }
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        final boolean hasAspMin = a.hasValue(R.styleable.SeekBarPreference_min);
        if (hasAspMin) {
    ...
    public void setValueFormatter(SeekBarPreference.ValueFormatter formatter) {
        mFormatter = formatter;
        if (isBindValueToSummary()) {
            setSummary(mFormatter != null ? mFormatter.getValue(getProgress())
                    : String.format(Locale.US, "%d", getProgress()));
        }
    }
...
//            Log.d("SBDP", "preferredProgress=" + preferredProgress);
        ...
        if (isBindValueToSummary()) {
            setSummary(mFormatter != null ? mFormatter.getValue(preferredProgress)
                    : String.format(Locale.US, "%d", preferredProgress));
        }
    }
